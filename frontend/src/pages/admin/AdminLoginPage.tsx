  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-6 flex items-center gap-2 px-5 py-2.5 rounded-lg cursor-pointer transition-all"
        style={{
          background: 'rgba(0,135,207,0.10)',
          border: '1px solid rgba(0,135,207,0.25)',
          color: '#6dcff6',
          fontFamily: "'Roboto Condensed', sans-serif",
          fontSize: 14,
        ...
        onMouseEnter={e => {
          e.currentTarget.style.background = 'rgba(0,135,207,0.22)';
          e.currentTarget.style.borderColor = 'rgba(0,135,207,0.50)';
          e.currentTarget.style.color = '#fff';
        }}
        onMouseLeave={e => {
          e.currentTarget.style.background = 'rgba(0,135,207,0.10)';
          e.currentTarget.style.borderColor = 'rgba(0,135,207,0.25)';
